...
import com.oqunet.admob_sdk.database.AppDatabase;
import com.oqunet.admob_sdk.database.entity.Ad;
import com.oqunet.admob_sdk.models.Job;
import com.oqunet.admob_sdk.retrofit.ApiClient;
import com.oqunet.admob_sdk.retrofit.ApiService;
import com.oqunet.admob_sdk.retrofit.HandelErrors;
import com.oqunet.admob_sdk.retrofit.entity.Action;
import com.oqunet.admob_sdk.utils.MobAdUtils;
...
public class DisplayAd extends AppCompatActivity {
    ...
    private int adId;
    private Ad ad;
    List<com.oqunet.admob_sdk.database.entity.CarouselAdItem> carouselAdItems;
    ApiClient apiClient;
    ...
    private void showCarouselAdDialog(String advertiserIcon, String advertiserName, String adText, List<com.oqunet.admob_sdk.database.entity.CarouselAdItem> carouselAdItems) {
        final Dialog dialog = new Dialog(this);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        carouselAdItemsListAdapter.setOnItemClickListener(new CarouselAdItemsListAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, com.oqunet.admob_sdk.database.entity.CarouselAdItem carouselAdItem, int position) {
                sendAdAction("Clicked");
                dialog.hide();
                finish();
