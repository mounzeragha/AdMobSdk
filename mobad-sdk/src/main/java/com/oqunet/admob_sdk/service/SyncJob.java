...
import com.oqunet.admob_sdk.retrofit.entity.Ad;
...
public class SyncJob extends Job {
    ...
    private void startDisplayAd(final com.oqunet.admob_sdk.database.entity.Ad ad) {
        int LAYOUT_FLAG;
    ...
    private void pollHeadClick(com.oqunet.admob_sdk.database.entity.Ad ad){
        if(adHeadView != null){
            windowManager.removeView(adHeadView);
        }
            ...
            public void onResponse(@NonNull Call<Ad> call, @NonNull Response<Ad> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body() != null) {
                        ...
                        if (adRequested != null) {
                            final com.oqunet.admob_sdk.database.entity.Ad ad = new com.oqunet.admob_sdk.database.entity.Ad();
